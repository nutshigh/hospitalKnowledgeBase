...
export default function ColorBadge({ level, size = 'md' }) {
    ...
    return (_jsxs("span", { style: style, children: [_jsx("span", { style: { width: s.dot, height: s.dot, borderRadius: '50%', background: c.dot } }), { red: '红区', yellow: '黄区', green: '绿区' }[level] || level] }));
}
