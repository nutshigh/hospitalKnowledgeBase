...
export default function ReportSelector({ sessionId }) {
    ...
    return (_jsx(Select, { allowClear: true, placeholder: "\u9009\u62E9\u4F53\u68C0\u62A5\u544A", style: { minWidth: 200 }, value: selectedReportId, onChange: handleChange, options: reports.map(r => ({
            value: r.id,
