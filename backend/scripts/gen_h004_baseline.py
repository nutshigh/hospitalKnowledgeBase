...
用法(backend 目录):
    .venv/bin/python scripts/gen_h004_baseline.py
"""
import hashlib
import json
import re
...
DB = "hospital_H004"
REPORT_IDS = [1, 2, 3, 5, 6, 21, 22, 23, 24, 25, 26, 27, 29, 38, 39, 40, 41, 43]  # 2026-09-16: +第三批 38-41/43
OUT = BACKEND / "tests" / "modules" / "report" / "baselines" / "h004_baseline.json"
